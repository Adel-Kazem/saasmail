...
INSERT INTO `__new_sender_identities`("email", "display_name", "display_mode", "created_at", "updated_at") SELECT "email", "display_name", "display_mode", "created_at", "updated_at" FROM `sender_identities`;--> statement-breakpoint
