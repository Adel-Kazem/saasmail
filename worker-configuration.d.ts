/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: e55306a2b85246d5a3a1e28060c569d8)
...
declare namespace Cloudflare {
	...
	interface Env {
		...
		EMAIL_QUEUE: Queue;
		ASSETS: Fetcher;
		TRUSTED_ORIGINS: "http://localhost:8080,http://localhost:8788,https://mail.givefeedback.dev";
		APP_NAME: "cmail";
		APP_LOGO_LETTER: "c";
		COOKIE_PREFIX: "cmail";
		BASE_URL: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "TRUSTED_ORIGINS" | "APP_NAME" | "APP_LOGO_LETTER" | "COOKIE_PREFIX" | "BASE_URL" | "DISABLE_PASSKEY_GATE" | "DEMO_MODE">> {}
}
